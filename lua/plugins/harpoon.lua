return {
  ...
  keys = {
    ...
    { "<M-h>", "<cmd>lua require('harpoon.ui').nav_file(1)<cr>", desc = "File 1" },
    { "<leader>h2", "<cmd>lua require('harpoon.ui').nav_file(2)<cr>", desc = "File 2" },
    { "<M-j>", "<cmd>lua require('harpoon.ui').nav_file(2)<cr>", desc = "File 2" },
    { "<leader>h3", "<cmd>lua require('harpoon.ui').nav_file(3)<cr>", desc = "File 3" },
    { "<M-k>", "<cmd>lua require('harpoon.ui').nav_file(3)<cr>", desc = "File 3" },
    { "<leader>h4", "<cmd>lua require('harpoon.ui').nav_file(4)<cr>", desc = "File 4" },
    { "<M-l>", "<cmd>lua require('harpoon.ui').nav_file(4)<cr>", desc = "File 4" },
